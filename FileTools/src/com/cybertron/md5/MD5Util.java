...
//	}
	 ...
	 * 生成字符串的md5校验值
	 */
	public static String getMD5String(String s, Charset set) throws NoSuchAlgorithmException {
		return getMD5String(s.getBytes(set));
	}
	...
	public static void main(String[] args) throws IOException {
		...
		File file = new File("e:/data/dict/__res__7765697975766f6362616e6b.voc");
